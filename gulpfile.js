...
gulp.task('fancybox:js', function() {
    return gulp.src('./public/lib/fancybox/source/jquery.fancybox.js')
        .pipe(uglify())
...
gulp.task('fancybox:css', function() {
    return gulp.src('./public/lib/fancybox/source/jquery.fancybox.css')
        .pipe(cssmin())
        .pipe(gulp.dest('./public/lib/fancybox/source/'));
});
//CSS压缩
...
gulp.task('build', ['uglify', 'cssmin', 'images', 'fancybox:js', 'fancybox:css','minify-html']);